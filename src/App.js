...
function App() {
  ...
  return (
    <div
      className="h-screen dark:bg-[#18191A] bg-[#F5F5F5] flex flex-col"
    >
      <header
      ...
      {isSearch === "" ? (
        <>
          {/* not found */}
          <main
            className="flex flex-1 flex-col items-center justify-center dark:bg-[#0E1117] bg-white"
          >
            <div
              className="flex h-[200px] w-[200px] flex-col items-center justify-center rounded-full border dark:border-gray-50/30"
            >
              <img
                src="images/icon.svg"
            ...
            <div
              className="mt-4 text-lg font-medium dark:text-gray-100 text-gray-700"
            >
              Chưa Nhập Mã Đơn
            </div>
            <div
        ...
        <main className="container mx-auto flex h-screen max-w-[1440px] flex-1 flex-col">
          {/* smartphone */}
          <div
            className="flex flex-1 flex-col space-y-3 sm:hidden dark:bg-[#0E1117] bg-white"
          >
            <DonHangSM
              id={donHang.id}
              date={donHang.date}
      ...
      <div
        ...
        dark:bg-gray-700 bg-gray-50 dark:border-gray-600 border-gray-200"
      >
        <div className="mx-auto grid h-full max-w-lg grid-cols-2">
          ...
          >
            <svg
              className="h-[20px] w-[20px] dark:text-white text-gray-800"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 20 20"
